...
6. **Receita total do Comercial ficou estável entre os períodos** (D1–D6 de cada campanha): R$ 1.401.396 no período CDL (05–10/mai, 1.824 vendas, ticket R$ 768) vs **R$ 1.436.220 (+2,5%)** no período ODI (17–22/jul, 1.185 vendas, ticket R$ 1.212 — último dia parcial na medição). −35% em volume, compensado por +58% de ticket (mix deslocado para Vitalício Aniv26). Ou seja: o time está faturando até um pouco MAIS do que na época em que vendia bem o CDL — a Odisseia é que não entrou na pauta.
...
8. **Contexto das conversas (qualitativo, 60 conversas)**: a operação atual é um fluxo "concierge" reativo ao e-mail de pré-venda — 36/60 usam o script "Membro Fundador da Coleção Grandes Obras do Ocidente" (persona "Bianca, concierge literária", operada por vários atendentes e bots); 16/60 é o cliente chegando por conta (preço/dúvida/reclamação); sem fila própria no Zenvia. Atritos recorrentes: objeção de preço, confusão Odisseia×CDL (12/60 — compradores do CDL se sentindo cobrados de novo), vitalícios cobrando o curso de 24 aulas como benefício incluso, pedidos de desconto por tier.
9. **Contexto que muda a régua**: o relatório SSR de 21/07 (`relatorios/odisseia/`) recomendou lançamento em fases — primeiro só aos ~23,7k compradores do CDL a R$ 1.200 via CRM, medir recompra, depois abrir base+mídia. Os dados são compatíveis com essa fase 1. Se intencional, a comparação com o lançamento full-force do CDL é régua errada.
