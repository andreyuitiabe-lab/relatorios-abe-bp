...
-- Janela: D-4 a D+n de cada campanha (CDL D1=2026-05-05, ODI D1=2026-07-17);
-- n é dinâmico no refresh.py. Snapshot abaixo: D-4 a D27 (13/08/2026).
WITH conv AS (
  ...
  WHERE DATE(dt_approach_start) BETWEEN '2026-05-01' AND '2026-05-31'
  UNION ALL
  SELECT 'ODI',
         ...
         id_seller
  FROM masterdata.dim_zenvia_approaches
  WHERE DATE(dt_approach_start) BETWEEN '2026-07-13' AND '2026-08-12'
)
