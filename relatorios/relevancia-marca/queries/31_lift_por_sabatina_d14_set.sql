-- RODADA 9b (16/09/2026) — query 22 reexecutada com pessoa-dias até 01/09 e compras até 15/09:
-- D+14 completo para TODAS as 9 sabatinas, incluindo Renan e Marçal (estreia na plataforma 19/08).
...
WITH sessoes AS (
  ...
  WHERE vl_watch_time_seconds >= 300
    ...
    AND DATE(dt_created_at) BETWEEN '2026-05-01' AND '2026-09-01'
),

janela AS (
  SELECT * FROM sessoes WHERE dia BETWEEN '2026-06-08' AND '2026-09-01'
),
...
compras AS (
  ...
  WHERE t.nm_status = 'approved' AND t.bl_is_renovation = FALSE
    AND DATE(t.dt_ordered_at) BETWEEN '2026-04-01' AND '2026-09-15'
),
